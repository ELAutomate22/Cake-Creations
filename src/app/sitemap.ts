...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${business.url}/order`, lastModified: now, changeFrequency: "monthly", priority: 0.9 },
    { url: `${business.url}/terms`, lastModified: now, changeFrequency: "yearly", priority: 0.2 },
    { url: `${business.url}/order-policy`, lastModified: now, changeFrequency: "yearly", priority: 0.3 },
