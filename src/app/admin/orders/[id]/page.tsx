  ...
  return (
    <div className="mx-auto max-w-7xl px-5 py-10 sm:px-8 sm:py-12">
      ...
      <OrderWorkspace
        ...
        balance={balance}
        /*
          When this order was settled in full, if it was.

          Worked out on the server from the payments actually recorded, not
          inferred on the screen. It decides whether deleting the order stops
          to ask, and a confirmation that claims money arrived recently when
          none did would be a falsehood told at the one moment it matters.
        */
        paidInFullAt={
          balance.outstandingPence === 0 && balance.paidPence > 0
            ? (payments
